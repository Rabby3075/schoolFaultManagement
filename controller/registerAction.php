...
$name = $fname = $mname = $gender= $religion = $dob = $phone = $category =$uname = $pass = "";
$success = $error = "";
$flag = false;
$destination = "../upload/";
...
//sleep(40);
    $check = get($uname);
    if (!$check){
        $result = register($name,$fname,$mname,$gender,$religion,$dob,$phone,$category,$uname,$email,$pass,$fileName);
        if ($result) {
